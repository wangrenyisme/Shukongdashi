...
def getTuili(pinpai, xinghao, errorid, describe, relationList, ret_dict):
    ...
    for xianxiang in miaoshu_xianxiang:
        for relationguzhang in relationguzhangs:
            ...
            if similar > 0.8:
                similarxianxiang.append(relationguzhang)
    ...
    print('tuilixianxiang:',tuilixianxiang)
...
def question_tuili():
    ...
    xinghao = 'GSK928TA'
    errorid = 'ALM401'
    question = '一台配套FANUC 6M的加工中心,在机床搬迁后，首次开机时，机床出现 剧烈振动，CRT显示401、430报警。'  # '某配套FANUC OMC的数控铣床，在加工过程中突然断电，重新开机，系 统电源无法正常接通。'
